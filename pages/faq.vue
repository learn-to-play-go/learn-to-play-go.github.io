<template>
  <div>
    <div class="content is-medium">
      ...
      <p>Go uses the Asian martial art system in which the ranks go as follows:</p>
      <ul>
        <li>Beginners start at the highest available Kyu rank, usually 25 Kyu (25k for short) online</li>
